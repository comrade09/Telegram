...
class Config(object):
    ...
    OWNER_ID = getenv("1442684727")
    STRING_SESSION = getenv("BQCqBuDr7KQZLWXGbPReLz3jfsbalqmQn7_sbPWdLpjK0uXcNJ44GfTUD4AFHnHMorMshwLLjPDA2eDpV7TEcjllr0ALV1P6Logf1QcBkgeGwhJPkc2oQ2Ba16qmUHklQRYP87ZdD27MeMMM9vgTUxfdKNbkWmE9XXaNw8DGM8TpK0_i4Q_c5_aFRndTHIfzBQg0Nw_jm8h7tQZCa9IL6m5t2tmY4q6TLnKE573O3DcwuqvSBjXQFekvvnBNtvJGtONko-PA1qnMKseMoa2IUiPyeH16gpb1c8Z3eN8HOlFK1MVVx8UlC58w5aOHENP3WAhUXLZhxo5QNP-e85uE5qyFAAAAAD3IyOkA", "")
    OWNER_USERNAME = getenv("@Ath2023", "")
    DB_URI = getenv("postgres://ffyxymnf:BNtsJOhdCSd5lFJdaeDC0v8S_i1SVA2F@heffalump.db.elephantsql.com/ffyxymnf", "")
    DB_URI = DB_URI.replace("postgres", "postgres://aygdhudt:91yNrrlwWBhYSuKYII9r1GiO_UtU1S3d@suleiman.db.elephantsql.com/aygdhudt")
