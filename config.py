...
class Config(object):
    ...
    DB_URI = getenv("DATABASE_URL" , "postgres://ffyxymnf:BNtsJOhdCSd5lFJdaeDC0v8S_i1SVA2F@heffalump.db.elephantsql.com/ffyxymnf", "password"="r13cVC13eO1WTLqjBu07pjIoUv-J5Pnz")
